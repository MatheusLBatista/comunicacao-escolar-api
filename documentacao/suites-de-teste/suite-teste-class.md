...
Testes de integracao (endpoint) que validam o fluxo de criacao de turmas.
...
| :---------------------------------- | :-------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------- |
| Autenticacao obrigatoria            | Rotas usam autenticacao por token Bearer.                                                                | Cobrir criacao sem token (401/498) e fluxo autenticado com token valido.     |
