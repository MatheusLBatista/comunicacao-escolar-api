...
} from '../../../utils/validators/schemas/zod/ComponenteSchema.js';
import {
  ComponenteQuerySchema,
  ComponenteIdSchema,
} from '../../../utils/validators/schemas/zod/querys/ComponenteQuerySchema.js';
import { CommonResponse } from '../../../utils/helpers/index.js';

jest.mock('../../../services/ComponenteService.js');
jest.mock('../../../utils/validators/schemas/zod/ComponenteSchema.js');
jest.mock(
  '../../../utils/validators/schemas/zod/querys/ComponenteQuerySchema.js',
);
...
describe('ComponenteController', () => {
  ...
  describe('criar', () => {
    ...
    it('deve retornar erro 400 para dados inválidos', async () => {
      ComponenteSchema.parse.mockImplementation(() => {
        throw { name: 'ZodError' };
      });
  ...
  describe('atualizar', () => {
    ...
    it('deve retornar erro 400 para dados inválidos', async () => {
      req.params = { id: '1' };
      ComponenteIdSchema.parse.mockReturnValue('1');
      ComponenteUpdateSchema.parse.mockImplementation(() => {
        throw { name: 'ZodError' };
      });
