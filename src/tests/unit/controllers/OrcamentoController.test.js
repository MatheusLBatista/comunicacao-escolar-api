...
describe('OrcamentoController', () => {
      ...
      const req = {
        body: {
          ...
          componentes: [
            ...
            {
              componente: '507f1f77bcf86cd799439014',
  ...
  describe('adicionarComponente', () => {
    it('deve adicionar componente válido', async () => {
      ...
      service.adicionarComponente.mockResolvedValue({
        _id: '507f1f77bcf86cd799439011',
        componente_orcamento: [{ nome: 'Resistor' }],
      });
    ...
    it('deve retornar erro 400 para dados inválidos', async () => {
      const req = {
        params: { orcamentoId: '507f1f77bcf86cd799439011' },
        body: { componente: '', quantidade: '0', fornecedor: '' },
      };
  ...
  describe('atualizarComponente', () => {
    it('deve atualizar componente existente', async () => {
      ...
      service.getComponenteById.mockResolvedValue({
        _id: '507f1f77bcf86cd799439012',
        nome: 'Resistor',
        quantidade: '2',
        valor_unitario: '1.5',
      });
      service.atualizarComponente.mockResolvedValue({
        _id: '507f1f77bcf86cd799439011',
        componente_orcamento: [
          { _id: '507f1f77bcf86cd799439012', quantidade: '5' },
        ],
      });
  ...
  describe('removerComponente', () => {
    it('deve remover componente existente', async () => {
      ...
      service.removerComponente.mockResolvedValue({
        _id: '507f1f77bcf86cd799439011',
        componente_orcamento: [],
      });
      await controller.removerComponente(req, res);
      expect(service.removerComponente).toHaveBeenCalledWith(
        '507f1f77bcf86cd799439011',
        'cid',
        req,
      );
    ...
    it('deve retornar erro 404 para componente inexistente', async () => {
      ...
      await expect(
        controller.removerComponente(req, res),
      ).rejects.toBeDefined();
    });
  });
