...
const Target = z.object({
    target_id: z.string().regex(/^[0-9a-fA-F]{24}$/, {
...
export const PostSchema = z.object({
    ...
    attachments: z.string({ message: "O attachments não é uma string válida." }).url({ message: "A url passada não é uma url válida." }).array().optional(),
