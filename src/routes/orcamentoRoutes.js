...
router
  ...
  .post(
    ...
    AuthPermission,
    asyncWrapper(
      orcamentoController.adicionarComponente.bind(orcamentoController),
    ),
  )
  .patch(
    ...
    AuthPermission,
    asyncWrapper(
      orcamentoController.atualizarComponente.bind(orcamentoController),
    ),
  )
  .delete(
    '/orcamentos/:orcamentoId/componentes/:id',
    ...
    AuthPermission,
    asyncWrapper(
      orcamentoController.removerComponente.bind(orcamentoController),
    ),
  );
