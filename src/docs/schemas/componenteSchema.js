...
componentesSchemas.ComponenteItem.example = await generateExample(
  componentesSchemas.ComponenteItem,
  null,
  componenteMongooseSchema,
);
componentesSchemas.ComponenteDetalhes.example = await generateExample(
  componentesSchemas.ComponenteDetalhes,
  null,
  componenteMongooseSchema,
);
